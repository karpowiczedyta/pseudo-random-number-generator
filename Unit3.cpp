...
void __fastcall TForm1::Button6Click(TObject *Sender)
{
	...
	if (n < 0) {
		ShowMessage("Liczba prób musi byæ wiêksza b¹dŸ równa 0!");
	}
	if (p > 1 || p < 0) {
	   ShowMessage("Prawdopodobieñstwo sukcesu musi zawieraæ siê w przedziale od 0 do 1!");
	}
	if (k > n || k < 0) {
		ShowMessage("Noœnik musi zawieraæ siê w przedziale od 0 do n!");
	}
...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
	...
	StringGrid1->Cells[1][0] = "Wartoœæ: ";
	StringGrid1->Cells[0][1] = "Œrednia";
	StringGrid1->Cells[0][2] = "Wariancja";
	StringGrid1->Cells[0][3] = "Wspó³czynnik skoœnoœci";
